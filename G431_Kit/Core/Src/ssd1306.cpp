...
{
	SysError_t err;
	err = hi2c->masterTransmit(OLED_ADR, Init_data, (uint16_t)size, 1000);
	OLED_AllClear(hi2c);
...
void OLED_Display(I2C *hi2c)
{
	...
	hi2c->masterTransmit(OLED_ADR, Display_Range, sizeof(Display_Range), 1000);

	for (int i = 0; i < 8; i++) {
		hi2c->masterTransmit(OLED_ADR, All_Display_Data[i], sizeof(All_Display_Data[i]), 1000);
	}
}
...
void OLED_Thrcot_Logo_Display(I2C *hi2c)
{
	...
	hi2c->masterTransmit(OLED_ADR, Logo_Range_Data, sizeof(Logo_Range_Data), 1000);

	hi2c->masterTransmit(OLED_ADR, Thrcot_Logo_Data1, sizeof(Thrcot_Logo_Data1), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Logo_Data2, sizeof(Thrcot_Logo_Data2), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Logo_Data3, sizeof(Thrcot_Logo_Data3), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Logo_Data4, sizeof(Thrcot_Logo_Data4), 1000);
}
...
void OLED_Thrcot_Large_Logo_Display(I2C *hi2c)
{
	...
	hi2c->masterTransmit(OLED_ADR, Large_Logo_Range, sizeof(Large_Logo_Range), 1000);

	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data1, sizeof(Thrcot_Large_Logo_Data1), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data2, sizeof(Thrcot_Large_Logo_Data2), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data3, sizeof(Thrcot_Large_Logo_Data3), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data4, sizeof(Thrcot_Large_Logo_Data4), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data5, sizeof(Thrcot_Large_Logo_Data5), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data6, sizeof(Thrcot_Large_Logo_Data6), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data7, sizeof(Thrcot_Large_Logo_Data7), 1000);
	hi2c->masterTransmit(OLED_ADR, Thrcot_Large_Logo_Data8, sizeof(Thrcot_Large_Logo_Data8), 1000);
}
...
void OLED_AllClear(I2C *hi2c)
{
	...
	hi2c->masterTransmit(OLED_ADR, Clear_Range, sizeof(Clear_Range), 1000);
